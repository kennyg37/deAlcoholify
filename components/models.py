...
def create_model_card(title, description, link, link_text):
    ...
    return html.Div([
        html.H2(title, className="text-lg font-semibold text-[#005CAB] mb-2"),
        html.P(description, className="text-black mb-4"),
...
def models_layout():
    ...
    return html.Div([
        # Header Section
        html.Div([
            html.H1("Models", className="text-4xl font-bold text-[#005CAB] mb-4"),
            html.P(
                "Explore various predictive models to analyze data and gain insights about the impact of alcohol consumption.",
                className="text-black mb-8"
            ),
        ], className="text-center bg-white p-8 shadow-md rounded-lg mb-8"),
        
        # Model Cards Section
        html.Div([
            html.H2("Choose a Model", className="text-2xl font-bold text-[#005CAB] mb-6 text-center"),
            html.Div([
                create_model_card(
                    title="Cancer Model",
